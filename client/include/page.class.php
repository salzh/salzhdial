<style>
 	  ...
 	  #page{font:12px/16px arial; height:30px;}
	  #page span{float:left;margin:0px 3px;}
	  #page a{float:left;margin:0 3px;border:1px solid #ddd;padding:3px 7px; text-decoration:none;color:#666}
	  #page a.now_page,#page a:hover{color:#fff;background:#68ba4b;}
</style>
...
<?php
	...
	class page
	{
	    ...
	    protected function show_1()
	    {
			...
			$return .= '<span >总计 ' .$this->total_rows. ' 个记录分为 ' .$this->total_pages. ' 页, 当前第 ' . $this->now_page . ' 页</span> ';
	        return $return;
	    }
