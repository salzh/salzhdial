		...
		public function GetDepList($bid=0)
		{
			...
			if($bid!="0")
			{
				foreach($list as $rs)
				{
 						if(strrpos(",".$bid.",", ",".$rs["ClassId"].",")>-1)
						{
						  $str=$str."<input name='depid[]' type='checkbox' id='bid'  checked='checked' value='".$rs['ClassId']."' /> "  . $rs['ClassName'] ."&nbsp;&nbsp;";
						}
						else
						{
						  $str=$str."<input name='depid[]' type='checkbox' id='bid'   value='".$rs['ClassId']."' /> "  . $rs['ClassName'] ." &nbsp;&nbsp;";
						}
				}
			}
			else
			{
				foreach($list as $rs)
				{
					...
					$str=$str."<input name='depid[]' type='checkbox'  value='".$rs['ClassId']."' /> "  . $rs['ClassName'] ."&nbsp;&nbsp;";
				}
			}
			return $str;	
		}
		...
		public function GetAreaList($bid=0)
		{
			...
			if($bid!="0")
			{
				foreach($list as $rs)
				{
 						if(strrpos(",".$bid.",", ",".$rs["ClassId"].",")>-1)
						{
						  $str=$str."<input name='areaid[]' type='checkbox' id='bid'  checked='checked' value='".$rs['ClassId']."' /> "  . $rs['ClassName'] ."&nbsp;&nbsp;";
						}
						else
						{
						  $str=$str."<input name='areaid[]' type='checkbox' id='bid'   value='".$rs['ClassId']."' /> "  . $rs['ClassName'] ." &nbsp;&nbsp;";
						}
				}
			}
			else
			{
				foreach($list as $rs)
				{
					...
					$str=$str."<input name='areaid[]' type='checkbox'  value='".$rs['ClassId']."' /> "  . $rs['ClassName'] ."&nbsp;&nbsp;";
				}
			}
			return $str;	
		}
