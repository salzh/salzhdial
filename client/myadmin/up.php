...
******************************************************************************/
$control= isset($_REQUEST['control']) ? $_REQUEST['control'] : 'pic';
//上传文件类型列表
$type= isset($_REQUEST['type']) ? $_REQUEST['type'] : 'pic';
if($type=="pic")
{
	$uptypes=array(
		'image/jpg',
...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
    ...
    {
	echo "<script>";
    echo "window.parent.document.form1.$control.value='".$destination2."';";
	echo "window.parent.document.getElementById('img').src='../".$destination."';";
	echo "</script>";
    }
	else
	{
