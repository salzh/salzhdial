...
<?
	if($a=="addsave")
	{
		...
		if($AreaClass->AddAreaClass($model)>0)
		{
	...
	if($a=="modifysave")
	{
		...
		if($AreaClass->EditAreaClass($model)>0)
		{
			echo Msg("操作成功","?action=list");
		}
	...
	if($a=="del")
	{
			...
			if($AreaClass->DelAreaClass($classid)>0)
				{
				echo Msg("操作成功","?action=list");
				} 
 	}
...
<div id="Layer1">
  ...
  <table width="100%" height="242" border="0" cellpadding="1" cellspacing="3" style="border:1px solid #ccc">
    ...
    <tr>
      <td width="16%" height="40" bgcolor="#FFFFFF"><div align="center">地区</div></td>
...
{
$classid= isset($_REQUEST['classid']) ? $_REQUEST['classid'] : 0;
$m= $AreaClass->GetClassModel($classid);
if($m!=NULL)
{
...
<div id="Layer2">
  ...
  <table width="88%" height="235" border="0" cellpadding="1" cellspacing="3" style="border:1px solid #ccc">
    ...
    <tr>
      <td width="21%" height="40" bgcolor="#FFFFFF"><div align="center">地区</div></td>
...
<div class="box">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="38%" height="45" style="border-bottom:2px #0066CC solid">&nbsp;<span class="title">地区管理 </span></td>
    ...
    <table width="500" height="38" border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF" style="margin-top:3px;">
      <tr>
        ...
        <td width="267" bgcolor="#ECF5FF"><div align="center">地区名称</div></td>
 ...
 ?>
      <tr height="28" bgcolor="#f5f5f5">
        ...
        <td width="55" bgcolor="#ffffff"><div align="center"><a href='javascript:if(confirm("确实要删除该内容吗,删除后再也找不回?"))location="?action=del&classid=<?=$rs['ClassId']?>&bid=0"'><img src="../images/del.gif" style="border:0;" /></a></div></td>
      </tr>
