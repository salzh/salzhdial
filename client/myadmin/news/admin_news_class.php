...
<?
	if($a=="addsave")
	{
		...
		if($newsclass->AddNewsClass($model)>0)
		{
	...
	if($a=="modifysave")
	{
		...
		if($newsclass->EditNewsClass($model)>0)
		{
			echo Msg("操作成功","?action=list");
		}
	...
	if($a=="del")
	{
		if($bid=='0')
		{
			...
			{
				if($newsclass->DelNewsClass($classid)>0)
				{
				echo Msg("操作成功","?action=list");
				}
			}
...
<div id="Layer1">
  ...
  <table width="100%" height="368" border="0" cellpadding="1" cellspacing="3" style="border:1px solid #ccc">
    <tr>
    ...
    <tr>
      <td height="40" bgcolor="#FFFFFF"><div align="center">页面关键字</div></td>
      <td height="40" bgcolor="#FFFFFF"><input name="keyword" type="text" id="keyword" size="50" maxlength="200" /></td>
    </tr>
    <tr>
...
<div id="Layer2">
  ...
  <table width="88%" height="352" border="0" cellpadding="1" cellspacing="3" style="border:1px solid #ccc">
    <tr>
      <td height="29" colspan="2" bgcolor="#0066CC"><div align="right"><a href="?action=list" style="color:#fff">关闭&nbsp;&nbsp; </a></div></td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="40" bgcolor="#FFFFFF"><div align="center">页面关键字</div></td>
      <td height="40" bgcolor="#FFFFFF"><input name="keyword" type="text" id="keyword" size="50" value="<?=$_keyWord?>" maxlength="200" /></td>
    </tr>
    <tr>
      <td height="32" bgcolor="#FFFFFF"><div align="center">页面描述</div></td>
      <td height="32" bgcolor="#FFFFFF"><input name="des" type="text" id="des" size="50" value="<?=$_des?>"  maxlength="200" /></td>
    </tr>
    <tr>
...
<div class="box">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="38%" height="45" style="border-bottom:2px #0066CC solid">&nbsp;<span class="title">品牌分类管理-添加</span></td>
 ...
 ?>
      <tr height="28" bgcolor="#f5f5f5">
        ...
        <td width="80" bgcolor="#f5f5f5"><div align="center"><a href="?action=add&bid=<?=$rs['ClassId']?>">添加子类</div></td>
...
<?
	$list2=$newsclass->GetClassList($rs['ClassId']);
	foreach($list2 as $rs2)
		{
?>
  <tr height="28">
        <td width="54" bgcolor="#FFFFFF"><div align="center"><?=$rs2['ClassId']?></div></td>
        <td width="267" bgcolor="#FFFFFF"><div align="left"><a href="?action=modify&classid=<?=$rs2['ClassId']?>&bid=<?=$rs2['Bid']?>">——<?=$rs2['ClassName']?>
        </a></div></td>
        <td width="80" bgcolor="#FFFFFF"><div align="center"> </td>
        ...
        <td width="55" bgcolor="#FFFFFF"><div align="center"><a href='javascript:if(confirm("确实要删除该贴吗,删除后再也找不回?"))location="?action=del&classid=<?=$rs2['ClassId']?>&bid=<?=$rs2['Bid']?>"'><img src="../images/del.gif" style="border:0;" /></a></div></td>
    </tr>
<?
		}
	}
