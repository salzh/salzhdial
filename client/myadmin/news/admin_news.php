...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <form id="form1" name="form1" method="get" action="?">
    <td width="49%" height="45" style="border-bottom:2px #218644 solid">&nbsp;<span class="title">新闻管理</span></td>
    <td width="19%" style="border-bottom:2px #218644 solid"><div align="right">
      <?
		echo $newsclass->GetBrandSelect("",$bid,$sid,$tid);
		?>
    </div></td>
    <td width="32%" height="45" style="border-bottom:2px #218644 solid">
      <div align="right">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#E6DB55" style="margin-top:5px;">
    ...
    <table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC" style="margin-top:5px;"  class="cooltable">
      <tr  height="35" style="color:#fff;">
        <td width="3%" bgcolor="#218644" ><div align="center">选择</div></td>
        <td width="4%" bgcolor="#218644" ><div align="center">编号</div></td>
        <td width="31%" bgcolor="#218644" ><div align="center">标题</div></td>
        <td width="50" bgcolor="#218644" ><div align="center">大类</div></td>
        <td width="50" bgcolor="#218644" ><div align="center">小类</div></td>
        <td width="6%" bgcolor="#218644" ><div align="center">状态</div></td>
        <td width="30" bgcolor="#218644" ><div align="center">点击</div></td>
        <td width="30" bgcolor="#218644" ><div align="center">留言</div></td>
        <td width="30" bgcolor="#218644" ><div align="center">回复</div></td>
        <td width="13%" bgcolor="#218644" ><div align="center">发布时间</div></td>
        <td width="14%" bgcolor="#218644" ><div align="center">操作</div></td>
      </tr> 
  <?php
