...
<table width="200" height="100" border="0" cellpadding="0" cellspacing="0">
  <tr>
	...
	<div class="leftMenu"   style="cursor:pointer"  onclick="show('list1');"><img src="images/yygl.png"/>&nbsp;&nbsp;语音管理&nbsp;&nbsp; </div>
		...
		<a  class="leftMenu_h"  href="news/auditing_news.php?action=add" target="right" >作业审核</a> 
	...
	<div class="leftMenu"   style="cursor:pointer"  onclick="show('list1');"><img style="margin-top:2px" src="images/yygl.png" />&nbsp;&nbsp;语音管理</div>
        ...
        <a  class="leftMenu_h"  href="work/sublist.php" target="right" >子账户作业查询</a>  
        ...
        <?
		if($_SESSION["userid"]==1||$_SESSION["upuserid"]==1)
		{
		?>
		<!--<a  class="leftMenu_h"  href="work/auditinglist.php" target="right" >作业审核</a>  -->
		<?
        if($_SESSION["userid"]==1)
		{
        ?>
		<a  class="leftMenu_h"  href="work/listall.php" target="right" >查看所有工作</a>
        <?
		}
		?>  
        <a  class="leftMenu_h"  href="voicetemplate/auditinglist.php" target="right" >语音模板审核</a>  
        <?
		}
		?>
        </span>	 
	...
	<div class="leftMenu"   style="cursor:pointer"  onclick="show('list2');"><img src="images/book.png"  style="margin-top:2px"/>&nbsp;&nbsp;数据管理</div>
		...
		<div  style="display:none"><a  class="leftMenu_h"   href="addressgroup/list.php" target="right" >常用联系人</a></div>
 	...
 	<div class="leftMenu"   style="cursor:pointer"  onclick="show('list4');"><img style="margin-top:2px" src="images/zhgl.png" />&nbsp;&nbsp;账户管理</div>
        ...
        <a  class="leftMenu_h"  href="recharge/retrieveMoney.php" target="right" >余额回收</a>  
