...
<div class="box">
  ...
  <form id="form1" name="form1" method="post" action="list.php" onsubmit="return check()">
    <table width="100%" height="70" border="0" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC">
      <tr>
        <td height="28" align="center" bgcolor="#FFFFFF"><table width="500" border="1" cellspacing="0" cellpadding="0">
          <tr>
            <td colspan="2" bgcolor="#218644" style="color:#FFF">综合查询</td>
            </tr>
          <tr>
            <td align="right"><?=$fun->GetComboList("SearchType",16,2)?></td>
            <td align="left"><input type="text" name="SearchValue" id="SearchValue" value="" maxlength="50" /></td>
          </tr>      
          <tr>
            <td align="right">地址簿</td>
            <td align="left"><?=$fun->GetComboList("GroupId","","","t_addressgroup","id,GroupName","",""," and UserId=".$_SESSION["userid"])?></td>
          </tr>  
          <tr>
            <td align="right">排序规则</td>
            <td align="left"><?=$fun->GetComboList("IdxType",16,2)?></td>
          </tr>                
          <tr>
            <td align="right">排序方式</td>
            <td align="left"><?=$fun->GetComboList("IdxOrder",17,1)?></td>
          </tr>
