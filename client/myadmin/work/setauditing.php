...
if($ac=="pass"){
	...
	$WorkState= isset($_REQUEST['WorkState'])? $_REQUEST['WorkState'] : '-1';
...
*Excel类型的地址本格式：第二列（商务电话必填）<a href="example.xls">范例[example]</a></td>
      ...
      <tr>
        ...
        <td height="28" bgcolor="#FFFFFF">
          <?=$fun->GetRadioList("VoiceType",13,$VoiceType)?>
        </td>
      </tr>
      <tr id="trVoiceTemplateId">
        <td height="28" align="center" bgcolor="#FFFFFF">语音模板选择</td>
        <td height="28" bgcolor="#FFFFFF">
          <?=$fun->GetComboList("VoiceTemplateId","",$VoiceTemplateId,"t_voice_template","id,TemplateName","",""," and UserId=".$_SESSION["userid"])?>
        </td>
      </tr>
      <tr id="trVoiceFile">
