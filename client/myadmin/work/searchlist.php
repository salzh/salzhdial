...
<div class="box">
  ...
  <form id="form1" name="form1" method="post" action="listdetail2.php" onsubmit="return check()">
    <table width="100%" height="70" border="0" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC">
      <tr>
        <td height="28" align="center" bgcolor="#FFFFFF"><table width="500" border="1" cellspacing="0" cellpadding="0">
          <tr>
            <td colspan="2" bgcolor="#218644" style="color:#FFF">清单查询</td>
            </tr>
          <tr>
          ...
          <tr>
            <td align="right"><?=$fun->GetComboList("SearchType",19,2)?></td>
