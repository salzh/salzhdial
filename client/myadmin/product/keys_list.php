...
<?
	if($a=="addsave"){
		$kinfo=new KeyWordsInfo();
 		$kinfo->OrderId=cint($orderby);
...
<div id="Layer1">
  ...
  <table width="87%"  border="0" cellpadding="1" cellspacing="3" style="border:1px solid #ccc">
    ...
    <tr>
      <td width="100" height="22" bgcolor="#FFFFFF"><div align="center">关键词</div></td>
...
<div class="box">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="38%" height="45" style="border-bottom:2px #0066CC solid">&nbsp;<span class="title"><strong>关键词管理</strong></span></td>
 ...
 ?>
        ...
        <td width="267" bgcolor="#f5f5f5" align="left"><a><?=$rs['orderid']?></a></td>
