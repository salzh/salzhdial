...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="72%" height="45" style="border-bottom:2px #0066CC solid">&nbsp;<span class="title">网站其他栏目管理</span></td>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#E6DB55" style="margin-top:5px;">
    ...
    <table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC" style="margin-top:5px;"  class="cooltable">
      <tr  height="35" style="color:#fff;">
        ...
        <td width="37%" bgcolor="#0066CC" ><div align="center">名称</div></td>
        <td width="17%" bgcolor="#0066CC" ><div align="center">类别</div></td>
        <td width="16%" bgcolor="#0066CC" ><div align="center">发布时间</div></td>
...
$keyword= isset($_REQUEST['keyword']) ? $_REQUEST['keyword'] : '';
 ...
 ?>
  <tr  height="30" >
        ...
        <td><div align="center">
		<a href="up_other.php?id=<?=$rs['id']?>&action=modify"><img src="../images/edit.png" style="border:0px;" /></a>&nbsp;&nbsp;&nbsp;&nbsp;
