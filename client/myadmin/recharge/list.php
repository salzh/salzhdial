...
<form id="form2" name="form2" method="post" action="?action=delall" onsubmit="return confirm('确定要删除吗，删除后不可恢复');">
  <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#E6DB55" style="margin-top:5px;">
    ...
    <table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC" style="margin-top:5px;"  class="cooltable">
      <tr style="color:#fff;">
        ...
        <td width="20%" bgcolor="#218644" ><div align="center">类型</div></td>
        <td width="10%" bgcolor="#218644" ><div align="center">用户账户</div></td>
        <td width="10%" bgcolor="#218644" ><div align="center">操作时间</div></td>
        <td width="10%" bgcolor="#218644" ><div align="center">账户余额（元）</div></td>
        <td width="10%" bgcolor="#218644" ><div align="center">充值（元）</div></td>
 ...
 ?>
  <tr>
        ...
        <td><?=$rs['username']?></td>
        <td><?=$rs['CreateDate']?></td>
        <td><?=$rs['CustomerMoney']?></td>
        <td><?=$rs['RechargeMoney']?></td>
