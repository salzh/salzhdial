...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="72%" height="45" style="border-bottom:2px #0066CC solid">&nbsp;<span class="title">网站BANNER管理</span></td>
    <td width="28%" height="45" style="border-bottom:2px #0066CC solid"><form id="form1" name="form1" method="post" action="?">
      <div align="right">
        ...
        <select name="types" id="types">
          ...
          <option value="关于力康">关于力康</option>
          <option value="力康动态">力康动态</option>
          <option value="力康产品">力康产品</option>
          <option value="解决方案">解决方案</option>
          <option value="力康服务">力康服务</option>
          <option value="加入力康">加入力康</option>
          <option value="联系我们">联系我们</option>
		  	   <option value="左侧广告">左侧广告</option>
		   <option value="首页左侧广告">首页左侧广告</option>
        </select>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#E6DB55" style="margin-top:5px;">
      ...
      <td height="36" bgcolor="#FFFBCC"><table width="100%" border="0" cellpadding="0" cellspacing="5" bgcolor="#FFFBCC">
        <tr>
          ...
          <td width="24%"><div align="right">
            ...
            <input type="button" name="Submit2" value="添加信息" onclick="location.href='up_banner.php?action=add'"  class="button" /> 
    ...
    <table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC" style="margin-top:5px;"  class="cooltable">
      <tr  height="35" style="color:#fff;">
        ...
        <td width="17%" bgcolor="#0066CC" ><div align="center">状态</div></td>
        <td width="17%" bgcolor="#0066CC" ><div align="center">类别</div></td>
        <td width="16%" bgcolor="#0066CC" ><div align="center">排序</div></td>
...
$types= isset($_REQUEST['types']) ? $_REQUEST['types'] : '';
	...
	$options = array(
 	...
 	$list2=$banner->GetPageList($s, $offset,$options['list_rows']);
	foreach($list2 as $rs)
	{ 
 ...
 ?>
  <tr  height="30" >
        ...
        <td><img src="../../<?=$rs['pic']?>" height="30" /></td>
        <td><a href="admin_banner.php?id=<?=$rs['id']?>&action=modifyshow&state=<?=$rs['show']?>"><?=$rs['show']==0?'非首页显示':'首页显示'?></a></td>
        <td><?=$rs['types']?></td>
        <td><div align="center">
          <?=$rs['orderid']?>
        </div></td>
        <td><div align="center">
		<a href="up_banner.php?id=<?=$rs['id']?>&action=modify"><img src="../images/edit.png" style="border:0px;" /></a>&nbsp;&nbsp;&nbsp;&nbsp;
